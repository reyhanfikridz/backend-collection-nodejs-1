  ...
  testInsert()
  {
    ...
    describe('Test model insert worker data', () => {
      ...
      it('should not catch any error', async () => {
        ...
        try {
          // insert data
          let worker = await workerModel.insert(this.server.db.pool, {
  ...
  testGet()
  {
    ...
    describe('Test model get worker data by ID', () => {
      ...
      it('should return the right data', async () => {
        ...
        try {
          // insert data
          insertedWorker = await workerModel.insert(this.server.db.pool, {
            full_name: 'James Bond',
            salary: 100000000,
            joining_date: '2022-11-21 18:00',
            department: 'Spy',
          ...
          // get data
          gettedWorker = await workerModel.getById(this.server.db.pool, insertedWorker.id)
        } catch (err) {
          // catch error
          error = err
        } finally {
      ...
      it('should catch an error because id not number', async () => {
        ...
        try {
          // insert data
          let insertedWorker = await workerModel.insert(this.server.db.pool, {
            full_name: 'James Bond',
            salary: 100000000,
            joining_date: '2022-11-21 18:00',
            department: 'Spy',
          ...
          // get data
          gettedWorker = await workerModel.getById(this.server.db.pool, "x")
        } catch (err) {
          // catch error
          error = err
        } finally {
    ...
    describe('Test model get all worker data', () => {
      ...
      it('should return the right data', async () => {
        ...
        try {
          ...
          worker = await workerModel.insert(this.server.db.pool, {
          ...
          // get data list
          gettedWorkers = await workerModel.getAll(this.server.db.pool)
        } catch (err) {
          error = err
        } finally {
          // check expected result
    ...
    describe('Test model update worker all fields by ID', () => {
      ...
      it('should return the right data', async () => {
        ...
        try {
          ...
          updatedWorker = await workerModel.updateAllFieldsById(this.server.db.pool, insertedWorker.id, {
            full_name: 'John Wick',
            salary: 20000000,
      ...
      it('should catch an error because id not number', async () => {
        ...
        try {
          ...
          // update all fields by ID
          updatedWorker = await workerModel.updateAllFieldsById(this.server.db.pool, "", {
            full_name: 'John Wick',
            salary: 20000000,
            joining_date: '2016-10-20 09:00',
            department: 'Agent',
    ...
    describe('Test model update worker minimal one field by ID', () => {
      ...
      it('should return the right data', async () => {
        ...
        try {
          ...
          updatedWorker[0] = await workerModel.updateById(this.server.db.pool, insertedWorker.id, {
            full_name: 'John Wick',
          })

          // get data after update field full_name
          gettedWorker[0] = await workerModel.getById(this.server.db.pool, insertedWorker.id)

          // update field salary by ID
          updatedWorker[1] = await workerModel.updateById(this.server.db.pool, insertedWorker.id, {
            salary: 20000000,
          })

          // get data after update field salary
          gettedWorker[1] = await workerModel.getById(this.server.db.pool, insertedWorker.id)

          // update field joining_date by ID
          updatedWorker[2] = await workerModel.updateById(this.server.db.pool, insertedWorker.id, {
            joining_date: "2016-01-01 10:00",
          })

          // get data after update field joining_date
          gettedWorker[2] = await workerModel.getById(this.server.db.pool, insertedWorker.id)

          // update field department by ID
          updatedWorker[3] = await workerModel.updateById(this.server.db.pool, insertedWorker.id, {
            department: "Agent",
          })

          // get data after update field department
          gettedWorker[3] = await workerModel.getById(this.server.db.pool, insertedWorker.id)
      ...
      it('should catch an error because id not number', async () => {
        ...
        try {
          ...
          // update field full_name by ID
          updatedWorker = await workerModel.updateById(this.server.db.pool, "", {
            full_name: 'John Wick',
          })
        } catch (err) {
          // catch error
  ...
  testDelete()
  {
    ...
    describe('Test model delete worker by ID', () => {
      ...
      it('should return the right data', async () => {
        ...
        try {
          // insert data list
          insertedWorkers[0] = await workerModel.insert(this.server.db.pool, {
            full_name: 'James Bond',
            salary: 100000000,
            joining_date: '2022-11-21 18:00',
            department: 'Spy',
          ...
          insertedWorkers[1] = await workerModel.insert(this.server.db.pool, {
            full_name: 'John Wick',
            salary: 20000000,
            joining_date: '2016-10-20 09:00',
            department: 'Agent',
          ...
          insertedWorkers[2] = await workerModel.insert(this.server.db.pool, {
            full_name: 'Michael Thomas',
            salary: 8000000,
          ...
          // delete data by id
          await workerModel.deleteById(this.server.db.pool, insertedWorkers[1].id)
      ...
      it('should catch an error because id not number', async () => {
        ...
        try {
          ...
          // delete by ID
          await workerModel.deleteById(this.server.db.pool, "test")
